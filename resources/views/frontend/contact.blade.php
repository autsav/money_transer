                ...
                <div class="col-md-4 mb-4">
                    <div class="bg-white shadow-md rounded h-100 p-3">
                        <div class="featured-box text-center">
                            ...
                            <h3>Siya Money Transfer</h3>
                            <p>782 harrow Road<br>
                                WEMBLEY, HA0 3BN</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 mb-4">
                    <div class="bg-white shadow-md rounded h-100 p-3">
                        <div class="featured-box text-center">
                            ...
                            <h3>Telephone</h3>
                            <p class="mb-0">(+060) 07984187708</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 mb-4">
                    <div class="bg-white shadow-md rounded h-100 p-3">
                        <div class="featured-box text-center">
                            ...
                            <h3>Email</h3>
                            <p class="mb-0">it@siyaexchange.com</p>
                            <p class="mb-0">info@siyaexchange.com</p>
                            <p class="mb-0">daxesh@siyaexchange.com</p>
                            <p>gurdev@siyaexchange.com</p>
                        </div>
                    </div>
                </div>
        ...
        <section class="hero-wrap section shadow-md">
            ...
            <div class="hero-content">
                <div class="container text-center">
                    <h2 class="text-9 text-white mb-5">Write to Us</h2>
                    <form action="" method="post" class="row">
                        <div class="col-lg-10 col-xl-8 mx-auto">
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    <input type="text" class="form-control" name="name" placeholder="Your Phone">
                                </div>
                                <div class="col-md-12 form-group">
                                    <textarea class="form-control" name="name" placeholder="Your Message*" rows="5" required></textarea>
                                </div>
                            </div>
        ...
        <div class="container">
            <div class="col-12 mb-4">
                <div class="text-center py-5 px-2">
                    ...
                    <p class="lead">Get connected with us using following social links.</p>
