    ...
    <div id="content">
        ...
        <section class="section bg-white">
            <div class="container">
                ...
                <p class="text-4 text-center mb-5">Here are some answers to most asked questions that may help you.</p>
                <div class="row">
                            ...
                            <div class="row no-gutters">
                                ...
                                <div class="col text-center text-sm-left">
                                    <div class="">
                                        ...
                                        <p class="text-muted mb-0">We want to answer all of your queries. Get in touch and we'll get back to you as soon as we can. <a class="btn-link" href="{{route('contact')}}">Contact us<span class="text-1 ml-1"><i class="fas fa-chevron-right"></i></span></a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
